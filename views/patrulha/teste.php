...
$this->title = Yii::t('app', 'Membros da Patrulha');
...
<div class="patrulha-teste">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Visualizar Patrulhas'), ['index'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                /*'label' => 'Nome',
                'value' => function($data){
                    return PatrulhaHasEscoteiro::getMembroPatrulha($data->idpatrulha);
                }*/
            ],
